...
class WarehouseLocationController extends Controller
{
    ...
    {
        return view('admin.warehouses.locations.index', ['warehouse' => $warehouse->load('locations')]);
    }

    public function create(Warehouse $warehouse): View
    {
        return view('admin.warehouses.locations.create', ['warehouse' => $warehouse, 'location' => new WarehouseLocation]);
    }
