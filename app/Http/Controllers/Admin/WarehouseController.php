...
class WarehouseController extends Controller
{
    ...
    public function create(): View { return view('admin.warehouses.create', ['warehouse' => new Warehouse()]); }
    ...
    public function show(Warehouse $warehouse): View { return view('admin.warehouses.show', ['warehouse' => $warehouse->load('locations')]); }
    public function edit(Warehouse $warehouse): View { return view('admin.warehouses.edit', compact('warehouse')); }
    ...
    private function validated(Request $request, ?Warehouse $warehouse = null): array
    {
        return $request->validate([
            ...
            'region' => ['nullable', 'string', 'max:100'], 'commune' => ['nullable', 'string', 'max:100'],
