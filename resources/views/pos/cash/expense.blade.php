@extends('layouts.pos')
@section('title', 'Egreso de caja')
@section('content')
<div class="row justify-content-center"><div class="col-lg-6"><form method="POST" action="{{ route('pos.cash.expense.store') }}" class="bg-white border rounded p-4">
@csrf
