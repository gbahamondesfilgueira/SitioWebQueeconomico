...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex align-items-center justify-content-between">
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>">Olvide mi password</a>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Aplicaciones con c#\SitioWebQueeconomico\resources\views\auth\login.blade.php ENDPATH**/ ?>